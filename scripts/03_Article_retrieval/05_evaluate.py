"""Step 5: Evaluate retrieval and reranking results.
...
Run:
  python scripts/03_Article_retrieval/05_evaluate.py
  python scripts/03_Article_retrieval/05_evaluate.py --domain money-heist
  python scripts/03_Article_retrieval/05_evaluate.py --stage retrieval  # skip reranking
"""
...
def evaluate_for_domain(
    ...
    setup_logger(log_dir, script_name="05_evaluate")
...
def main() -> None:
    ...
    for domain in domains:
        ...
        update_article_retrieval_stats(domain, cu.get_research_csv_path(config, domain))

#!/usr/bin/env python3
"""Run span identification on Skanda (1× A6000). Uses configs/span_id/skanda.yaml."""
...
def main() -> None:
    config_path = PROJECT_ROOT / "configs" / "span_id" / "skanda.yaml"
    ...
    for domain in domains:
        log = setup_span_id_logger(
            ...
            script_name="01_run_span_id_skanda",
        )
        for granularity in granularities:
